...
namespace ProjetoInventti
{
    public static class CargaInicialDeDados
    {
        ...
        public static List<Pessoa> GerarCarga()
        {
            ...
            {
                new Morador("morador 1", DateTime.Now, carro, "telefone 1", "usuario1", "senha1", predio[0]),
                new Morador("morador 2", DateTime.Now, carro, "telefone 2", "usuario2", "senha2", predio[0]),
                new Morador("morador 3", DateTime.Now, carro, "telefone 3", "usuario3", "senha3", predio[0]),

                new Administrador("administrador 1", DateTime.Now, carro, "telefone 1", "usuario4", "senha4"),
                new Administrador("administrador 2", DateTime.Now, carro, "telefone 2", "usuario5", "senha5"),
                new Administrador("administrador 3", DateTime.Now, carro, "telefone 3", "usuario6", "senha6"),

                new Sindico("síndico 1", DateTime.Now, predio[0], carro, "telefone 1", "usuario7", "senha7", 1000.00),
                new Sindico("síndico 2", DateTime.Now, predio[0], carro, "telefone 2", "usuario8", "senha8", 1000.00),
                new Sindico("síndico 3", DateTime.Now, predio[0], carro, "telefone 3", "usuario9", "senha9", 1000.00),

                new Zelador("zelador 1", DateTime.Now, carro, "telefone 1", "usuario10", "senha10", predio[0], 1000.00),
                new Zelador("zelador 2", DateTime.Now, carro, "telefone 2", "usuario11", "senha11", predio[0], 1000.00),
                new Zelador("zelador 3", DateTime.Now, carro, "telefone 3", "usuario12", "senha12", predio[0], 1000.00)
            };
            return lista;
        }
